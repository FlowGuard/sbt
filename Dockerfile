...
RUN ls -al   var/cache/apt/archives/partial/
#RUN ls -al   var/cache/apt/lists/
...
RUN mkdir -p /usr/lib/jvm/ && \
    ln -s /usr/local/openjdk-$JAVA_VERSION/ /usr/lib/jvm/java-$JAVA_VERSION-openjdk-amd64 && \
    touch /usr/lib/jvm/java-$JAVA_VERSION-openjdk-amd64/release
